...
use Water\Vular\Post\Models\PostAttribute;
use Water\Vular\Post\Models\PostCategory;
use Water\Vular\Post\Models\PostTag;
use Water\Vular\Models\Product;
use Water\Vular\Core\VularResponse;
use Water\Vular\PreMades\Web\Base\OgEdit;
use Water\Vular\PreMades\Web\Base\SeoEdit;

class PostEdit extends TwoColumnsFormPage{
    protected $modelClass = \Water\Vular\Post\Models\Post::class;
